...
# canny_img = cv.Canny(img, 0, 255, cv.BORDER_DEFAULT)
# cv.imshow('cat_canny',canny_img)

# canny_blur = cv.Canny(blur, 0, 255, cv.BORDER_DEFAULT)
# cv.imshow('cat_canny_blur',canny_blur)
...
parser.add_argument(
    ...
    default="D:\Dnk_project\output\\astronaut.png",
)
