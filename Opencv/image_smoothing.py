...
parser = argparse.ArgumentParser(
    description="Code for More Morphology Transformations tutorial."
)
parser.add_argument(
    "--input", help="Path to input image.", default="D:/Dnk_project/output/akshay1.jpg"
)
...
cv.createTrackbar(
    title_trackbar_operator_type, title_window, 0, max_operator, morphology_operations
)
cv.createTrackbar(
    title_trackbar_element_type, title_window, 0, max_elem, morphology_operations
)
cv.createTrackbar(
    title_trackbar_kernel_size, title_window, 0, max_kernel_size, morphology_operations
)
